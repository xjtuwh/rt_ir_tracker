...
def main(mode='IR', visulization=False):
    ...
    output_dir = os.path.join('results', 'atom_rgbt')
    output_video_path = '/media/hp/01a64147-0526-48e6-803a-383ca12a7cad/WH/wh2020/anti-UAV/visualize/' + 'atom_rgbt/'
    # setup tracker
    ...
    for video_id, video_path in enumerate(video_paths, start=1):
        ...
        while True:
            ...
            if frame_id == 0:
                ...
                # translation_vec_ir, scale_ind_ir, s_ir, flag_ir = tracker_ir.localize_target(scores_raw_ir)
                # ------------ RGB Tracking ---------------#
                ...
                # score_map = score_map_ir * 0.7 + score_map_rgb * 0.3
