...
def main(mode='IR', visulization=False):
    ...
    output_video_path = '/media/hp/01a64147-0526-48e6-803a-383ca12a7cad/WH/wh2020/anti-UAV/visualize/' + 'atom_expand2/'
    ...
    for video_id, video_path in enumerate(video_paths, start=1):
        ...
        while True:
            ...
            if frame_id == 0:
                ...
                # if max_score_ir < th_low * max_score_ref and psr < 50:
                ...
                if max_score_ir < th_low * max_score_ref:
                    ...
                    if max_response > th_pass * max_score_ref:
                        if max_response == up and calc_psr(scores_raw_up[0]) > psr_pass:
                        ...
                        if max_response == down and calc_psr(scores_raw_down[0]) > psr_pass:
                        ...
                        if max_response == left and calc_psr(scores_raw_left[0]) > psr_pass:
                        ...
                        if max_response == right and calc_psr(scores_raw_right[0]) > psr_pass:
            ...
            if visulization:
                ...
                cv2.putText(frame, 'Max score PSR = {:.2f}'.format(psr),
