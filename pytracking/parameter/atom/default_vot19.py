...
def parameters():
    ...
    # Training parameters
    params.sample_memory_size = 100              # Memory size
    ...
    params.augmentation_expansion_factor = 1.4    # How much to expand sample when doing augmentation
    ...
    # deep_feat = deep.ATOMResNet18(net_path='/media/hp/01a64147-0526-48e6-803a-383ca12a7cad/WH/wh2019/pytracking/ltr/save_models/checkpoints/ltr/bbreg/atom_default_a——g/ATOMnet_ep0040.pth.tar', output_layers=['layer3'], fparams=deep_fparams,
    #                               normalize_power=2)
