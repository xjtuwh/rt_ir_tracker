...
def parameters():
    ...
    # params.scale_factors = 1.01**torch.arange(-2, 3).float() # What scales to use for localization (only one scale if IoUNet is used)
    ...
    deep_feat = deep.ATOMResNet18(net_path='/media/hp/01a64147-0526-48e6-803a-383ca12a7cad/WH/wh2020/anti-UAV/Anti-UAV-master/Eval/ltr/save_models/checkpoints/ltr/bbreg/atom_default_ori/ATOMnet_ep0040.pth.tar', output_layers=['layer3'], fparams=deep_fparams,
                                  normalize_power=2)
