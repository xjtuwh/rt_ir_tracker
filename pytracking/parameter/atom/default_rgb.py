...
def parameters():
    ...
    params.train_skipping = 40          # How often to run training (every n-th frame)
    ...
    params.box_jitter_sz = 0.2              # How much to jitter the scale for random boxes
    ...
    deep_feat = deep.ATOMResNet18(net_path='/media/hp/01a64147-0526-48e6-803a-383ca12a7cad/WH/wh2019/pytracking/ltr/save_models/checkpoints/ltr/bbreg/atom_default_aa/ATOMnet_ep0040.pth.tar', output_layers=['layer3'], fparams=deep_fparams,
                                  normalize_power=2)
    # deep_feat = deep.ATOMResNet18(
    #     net_path='/media/hp/01a64147-0526-48e6-803a-383ca12a7cad/WH/wh2019/pytracking/ltr/save_models/checkpoints/ltr/bbreg/atom_default_ori/ATOMnet_ep0040.pth.tar',
