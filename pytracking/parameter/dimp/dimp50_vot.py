...
def parameters():
    ...
    params.net = NetWithBackbone(net_path='/media/hp/01a64147-0526-48e6-803a-383ca12a7cad/WH/wh2019/pytracking/ltr/save_models/checkpoints/ltr/dimp/dimp50/DiMPnet_ep0050.pth.tar',
