...
def parameters():
    ...
    params.net = NetWithBackbone(net_path='/media/hp/01a64147-0526-48e6-803a-383ca12a7cad/WH/wh2020/anti-UAV/Anti-UAV-master/Eval/ltr/save_models/checkpoints/ltr/dimp/dimp18/DiMPnet_ep0050.pth.tar',
                                 use_gpu=params.use_gpu)
