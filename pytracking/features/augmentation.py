...
class GridMask(Transform):
    ...
    def __init__(self, output_sz = None, shift = None, use_h=1, use_w=1, rotate=1, offset=False, ratio=0.6, mode=0, prob=1):
        super().__init__(output_sz, shift)
        self.use_h = use_h
        self.use_w = use_w
        self.rotate = rotate
    ...
    def __call__(self, x):
        if isinstance(x, torch.Tensor):
            ...
            return self.crop_to_output(x.view(1, -1, sz[0], sz[1]))
        else:
            raise NotImplementedError