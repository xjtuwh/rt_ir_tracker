...
def run(settings):
    ...
    # visdrone_train = visdrone() # lasot_train #
    # Validation datasets
    # got10k_val = Got10k(settings.env.got10k_dir, split='votval')
    # visdrone_val = VisdroneVal()  # lasot_train#
    ir_train = IR234()
    ...
    # Optimizer
    optimizer = optim.Adam([{'params': actor.net.classifier.filter_initializer.parameters(), 'lr': 1.25e-5},
                            {'params': actor.net.classifier.filter_optimizer.parameters(), 'lr': 1.25e-4},
                            {'params': actor.net.classifier.feature_extractor.parameters(), 'lr': 1.25e-5},
                            {'params': actor.net.bb_regressor.parameters(), 'lr': 0.00025},
