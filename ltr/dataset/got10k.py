...
class Got10k(BaseDataset):
    ...
    def __init__(self, root=None, image_loader=default_image_loader, split=None, seq_ids=None, data_fraction=None):
        ...
        self.img_ir = '/media/hp/01a64147-0526-48e6-803a-383ca12a7cad/DataSet/got_10k/train'
    ...
    def get_frames(self, seq_id, frame_ids, anno=None):
        ...
        frame_list = [self._get_frame(os.path.join(self.img_ir, self.sequence_list[seq_id]), f_id) for f_id in frame_ids]
