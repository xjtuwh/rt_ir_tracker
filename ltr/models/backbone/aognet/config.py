...
# aognet
_C.aognet = CN()
_C.aognet.filter_list = [32, 128, 256, 512, 824]
_C.aognet.out_channels = [0,0]
_C.aognet.blocks = [2, 2, 2, 1]
_C.aognet.dims = [2, 2, 4, 4]
_C.aognet.max_split = [2, 2, 2, 2] # must >= 2
_C.aognet.extra_node_hierarchy = [4, 4, 4, 4]  # 0: none, 1: tnode topdown, 2: tnode bottomup layerwise, 3: tnode bottomup sequential, 4: non-term node lateral, 5: tnode bottomup
_C.aognet.remove_symmetric_children_of_or_node = [1, 2, 1, 2]
...
_C.aognet.when_downsample = 1 # 0: at T-nodes, 1: before a aogblock, by conv_norm_ac + avgpool
